...
public class GoupiaotongjiController {
    ...
    public R page(@RequestParam Map<String, Object> params,GoupiaotongjiEntity goupiaotongji,
		@RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) Date goupiaoriqistart, 
    		@RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) Date goupiaoriqiend,
		HttpServletRequest request){
        EntityWrapper<GoupiaotongjiEntity> ew = new EntityWrapper<GoupiaotongjiEntity>();
		if(goupiaoriqistart!=null) ew.ge("goupiaoriqi", goupiaoriqistart);
        	if(goupiaoriqiend!=null) ew.le("goupiaoriqi", goupiaoriqiend);
