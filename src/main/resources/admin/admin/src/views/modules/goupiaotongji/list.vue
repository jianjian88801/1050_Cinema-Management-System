      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                  ...
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.daoyan" placeholder="导演" clearable></el-input>
                                                                                                                                                                    ...
                                                                                                                                                                    <el-form-item :label="contents.inputTitle == 1 ? '购票日期' : ''">
                  <el-date-picker
                      v-model="searchForm.goupiaoriqistart"
                      type="date"
                      placeholder="购票日期">
                  </el-date-picker>
                  至
                  <el-date-picker
                      v-model="searchForm.goupiaoriqiend"
                      type="date"
                      placeholder="购票日期">
                  </el-date-picker>
              </el-form-item>
      ...
      let params = {
        ...
        sort: 'id',
            ...
            params['daoyan'] = '%' + this.searchForm.daoyan + '%'
                                                                                                                                                    ...
                                                                                                                                                    if(this.searchForm.goupiaoriqistart!='' && this.searchForm.goupiaoriqistart!=undefined ){
            params['goupiaoriqistart'] = this.searchForm.goupiaoriqistart
          }
          if(this.searchForm.goupiaoriqiend!='' && this.searchForm.goupiaoriqiend!=undefined){
            params['goupiaoriqiend'] = this.searchForm.goupiaoriqiend
          }
                                                    this.$http({
